                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-hidden">Get My Helper</b>
                          <b className="is-hidden">Electrician</b>
                          <b className="is-visible">Chef</b>
                          <b className="is-hidden">Plumber</b>
                        </span>
                      </h1>
                ...
                <div className="row">
                  <div className="col-md-4 col-sm-6 col-xs-12 about-col">
                    <div className="about-image">
                      <img
                        src="assets/cv/sanajit-jana-profile.jpg"
                        alt="sanajit-jana"
                  ...
                  <div className="col-md-8 col-sm-6 col-xs-12 about-col">
                    <div className="about-details wow fadeIn">
                      ...
                      <a
                        ...
                        href="assets/cv/sanajit-jana-profile.jpg"
                        target="_blank"
                      >
                        See Resume
                      </a>
                  ...
                  <div className="row contact-info-row text-center wow fadeIn">
                    ...
                    <div className="col-md-3 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".4s">
                        ...
                        >
                          contact.nannevaibhav@gmail.com
                        </a>
                      </div>
                    </div>
                    <div className="col-md-3 col-sm-6 contact-colamn">
                  ...
                  <div class="col-md-12 col-sm-12 map-col">
                    <div class="google-maps">
                      <div class="map-wrap">
                        <iframe
                          title="google-maps"
                          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3784.5760776475922!2d73.8482586749414!3d18.45754717109685!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2eac85230ba47%3A0x871eddd0a8a0a108!2sSCTR&#39;S%20Pune%20Institute%20of%20Computer%20Technology!5e0!3m2!1sen!2sin!4v1699462832600!5m2!1sen!2sin" width="100%"
                          height="450"
                          style={{ border: "0" }}
                          allowFullScreen=""
                          loading="lazy"
